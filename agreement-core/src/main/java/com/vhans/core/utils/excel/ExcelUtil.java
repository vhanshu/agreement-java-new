package com.vhans.core.utils.excel;

import com.vhans.core.annotation.Excel;
import com.vhans.core.annotation.Excel.ColumnType;
import com.vhans.core.annotation.Excel.Type;
import com.vhans.core.annotation.Excels;
import com.vhans.core.utils.data.DateUtils;
import com.vhans.core.utils.file.FileUtils;
import com.vhans.core.utils.file.ImageUtils;
import com.vhans.core.utils.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column) {
        ...
        try {
            ...
            if (attr.isExport()) {
                ...
                cell.setCellStyle(styles.get(StringUtils.format("data_{}_{}_{}",
                        attr.align(), attr.color(), attr.backgroundColor())));
                // 用于读取对象中的属性
    ...
    private void createExcelField() {
        ...
        this.fields = this.fields.stream().sorted(Comparator.comparing(objects ->
                ((Excel) objects[1]).sort())).collect(Collectors.toList());
