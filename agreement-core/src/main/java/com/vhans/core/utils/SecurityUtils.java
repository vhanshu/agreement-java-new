...
public class SecurityUtils {
     ...
     * @return 是否正确
     */
    public static boolean checkPwByName(String name, String target, String target2) {
        String encryptedPassword = md5BySaltEncrypt(target2, name);
        return StringUtils.equals(encryptedPassword, target);
    }
     ...
     * @return 加密后的密码
     */
    public static String md5BySaltEncrypt(String password, String salt) {
