package com.vhans.bus.log.aspect;

import com.alibaba.fastjson2.JSON;
import com.vhans.bus.log.aspect.factory.AsyncFactory;
import com.vhans.bus.log.domain.ExceptionLog;
import com.vhans.core.manager.AsyncManager;
...
public class ExceptionLogAspect {
     ...
     */
    @Pointcut("execution(* com.vhans.*.controller.*(..))")
    ...
    public void doAfterThrowing(JoinPoint joinPoint, Throwable e) {
        ...
        // 获取当前请求的属性信息，其中包括 ServletRequestAttributes 对象，
        // 它封装了当前请求的 HttpServletRequest 和 HttpServletResponse 对象
        ServletRequestAttributes attributes = (ServletRequestAttributes) RequestContextHolder.getRequestAttributes();
        // 获取request
        HttpServletRequest request = Objects.requireNonNull(attributes).getRequest();
        // 获取当前方法所属类的 @Api 注解对象，并将其转换为 Api 类型
